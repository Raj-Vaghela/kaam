...
export const MOCK_PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        category: "Beverages",
        imgUrl:
            "https://images.unsplash.com/photo-1594631252845-29fc4cc8cde9?auto=format&fit=crop&q=80&w=600",
        price: 4.99,
        unit: "1kg",
        weight_kg: 1,
        rating: 4.9,
    ...
    },
    {
        ...
        category: "Flour & Atta",
        imgUrl:
            "https://images.unsplash.com/photo-1627485937980-221c88ac04f9?auto=format&fit=crop&q=80&w=600",
        price: 9.99,
        unit: "10kg",
        weight_kg: 10,
        rating: 4.7,
    ...
    },
    {
        ...
        imgUrl:
            "https://images.unsplash.com/photo-1559591937-e1dc329ac5a4?auto=format&fit=crop&q=80&w=600",
        price: 3.25,
        unit: "200g",
        weight_kg: 0.2,
        rating: 4.4,
...
export const CATEGORY_IMAGES: Record<string, string> = {
    ...
    Beverages:
        "https://images.unsplash.com/photo-1563911302283-d2bc129e7c1f?auto=format&fit=crop&q=80&w=400",
    "Dairy & Pantry":
        "https://images.unsplash.com/photo-1628193479753-9694b281f62c?auto=format&fit=crop&q=80&w=400",
    "Personal Care":
        "https://images.unsplash.com/photo-1556228720-1957be83f360?auto=format&fit=crop&q=80&w=400",
};
