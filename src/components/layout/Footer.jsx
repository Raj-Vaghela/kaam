...
const Footer = () => {
    ...
    const handleSubscribe = async () => {
        if (!email) return;
        setSubscribing(true);
        await OdooService.subscribeNewsletter(email); // Adds to 'mailing.contact'
        setSubscribing(false);
        setEmail("");
        alert("Subscribed! Your details have been added to our Odoo Mailing List.");
    };
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12 border-b border-slate-800 pb-12">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <div className="bg-emerald-800 text-white p-1.5 rounded-sm">
                                <span className="font-serif font-black text-xl leading-none block">D</span>
                            </div>
                            <h2 className="text-2xl font-serif font-bold text-white tracking-tight">DESI<span className="text-emerald-500">MART</span></h2>
                        </div>
                        <p className="text-slate-400 text-sm max-w-md">
                            Bringing the authentic taste of India to UK homes since 2010.
                            Fresh ingredients, premium spices, and trusted brands delivered to your door.
                        </p>
                    </div>
                    <div className="w-full md:w-auto bg-slate-800/50 p-6 rounded-lg border border-slate-700">
                        ...
                        <p className="text-xs text-slate-400 mb-4">Get £10 off your first order over £60.</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    <div>
                        <h4 className="text-white font-bold mb-4 font-serif text-lg">Shop</h4>
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="#" className="hover:text-emerald-400 transition-colors">Seasonal Specials</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold mb-4 font-serif text-lg">Help & Support</h4>
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="#" className="hover:text-emerald-400 transition-colors">Track My Order</a></li>
                            <li><a href="#" className="hover:text-emerald-400 transition-colors">FAQs</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold mb-4 font-serif text-lg">About Us</h4>
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="#" className="hover:text-emerald-400 transition-colors">Store Locator</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold mb-4 font-serif text-lg">Contact</h4>
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start gap-3">
                                <MapPin size={16} className="text-emerald-500 mt-0.5 shrink-0" />
                                <span>123 Wembley High Rd,<br />London, HA9 6AH</span>
                            </li>
                ...
                <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
                    ...
                    <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 transition-all duration-300">
                        <div className="h-6 w-10 bg-white rounded flex items-center justify-center font-bold text-slate-800 text-[8px]">VISA</div>
                        <div className="h-6 w-10 bg-white rounded flex items-center justify-center font-bold text-slate-800 text-[8px]">MC</div>
                        <div className="h-6 w-10 bg-white rounded flex items-center justify-center font-bold text-slate-800 text-[8px]">PAYPAL</div>
                    </div>
                </div>
            </div>
        </footer>
