...
const HeroSection = ({ onShopNow }) => (
    <div className="relative rounded-lg mx-4 sm:mx-6 lg:mx-8 mt-6 overflow-hidden shadow-xl border-b-4 border-amber-400 min-h-[500px] flex items-center">
        <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/90 via-transparent to-transparent md:hidden"></div>
        </div>
        ...
        <div className="relative z-10 px-6 py-12 md:pl-20 flex flex-col items-start text-left max-w-4xl w-full">
            ...
            <p className="text-lg md:text-xl text-emerald-100 max-w-xl mb-10 leading-relaxed font-light drop-shadow-sm">
                The finest Indian groceries, sourced directly and delivered to your doorstep. From everyday staples to rare spices.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <button onClick={onShopNow} className="bg-red-600 text-white font-bold py-4 px-8 rounded hover:bg-red-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2">
                    Shop Groceries <ArrowRight size={20} />
                </button>
                <button onClick={onShopNow} className="bg-white/10 backdrop-blur-md border border-white/30 text-white font-bold py-4 px-8 rounded hover:bg-white/20 transition-all flex items-center justify-center gap-2">
                    View Offers
                </button>
            </div>
        </div>
